...
const fr = {
  ...
  memberships: {
    overline: "Abonnements",
    title: "Nos formules d'engagement",
    subtitle: "Pour installer une pratique régulière et durable, choisissez le rythme qui vous convient.",
    cta: "S'abonner",
    cards: [
      {
        ...
        credits: "4 crédits",
        validity: "Valide 1 mois",
        description: "Un rendez-vous hebdomadaire pour prendre soin de votre corps en douceur. Idéal pour renforcer votre posture et libérer les tensions durablement.",
        href: "https://backoffice.bsport.io/customer/payment/pass/752047/?membership=5398&force=true",
      },
      {
        ...
        credits: "8 crédits",
        validity: "Valide 1 mois",
        description: "Le rythme idéal pour une vraie dynamique de transformation. Les bienfaits s'ancrent, les muscles s'éveillent et votre posture s'aligne avec constance.",
        featured: true,
        href: "https://backoffice.bsport.io/customer/payment/pass/752044/?membership=5398&force=true",
      },
      {
        name: "Illimité",
        price: "249 €",
        credits: "31 crédits",
        validity: "Valide 1 mois",
        description: "La liberté totale de pratiquer selon vos besoins. Intégrez le Pilates à votre quotidien pour des progrès naturels et une vitalité sans limite.",
        href: "https://backoffice.bsport.io/customer/payment/pass/752048/?membership=5398&force=true",
      },
    ],
  },
  location: {
...
const en: typeof fr = {
  ...
  memberships: {
    ...
    title: "Our commitment plans",
    subtitle: "To establish a regular and lasting practice, choose the pace that suits you.",
    cta: "Subscribe",
    cards: [
      {
        name: "1 session / week",
        ...
        credits: "4 credits",
        validity: "Valid 1 month",
        description: "A weekly appointment to gently care for your body. Ideal for strengthening posture and releasing tension lastingly.",
        href: "https://backoffice.bsport.io/customer/payment/pass/752047/?membership=5398&force=true",
      },
      {
        ...
        credits: "8 credits",
        validity: "Valid 1 month",
        description: "The ideal pace for true transformation. Benefits take root, muscles awaken, and your posture aligns with consistency.",
        featured: true,
        href: "https://backoffice.bsport.io/customer/payment/pass/752044/?membership=5398&force=true",
      },
      {
        ...
        credits: "31 credits",
        validity: "Valid 1 month",
        description: "Total freedom to practice as needed. Integrate Pilates into your daily life for natural progress and limitless vitality.",
        href: "https://backoffice.bsport.io/customer/payment/pass/752048/?membership=5398&force=true",
      },
    ],
  },
